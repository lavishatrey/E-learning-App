...
export const changeRole = (data,userId) => (dispatch) => {
    ...
    fetch(`http://localhost:3005/users/Teachme/${userId}`, {
      method: "GET",
      headers: {
...
export const getCourse = (data,userId) => (dispatch) => {
  dispatch({ type: PRODUCT_REQUEST });
  fetch(`http://localhost:3005/courses/a/${userId}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`
...
export const addProduct=(data)=>(dispatch)=>{
  dispatch({type:PRODUCT_REQUEST})
  fetch("http://localhost:3005/courses/add",{
    method:"POST",
    headers:{
      "Content-Type":"application/json",
      Authorization:`Bearer ${token}`
...
export const addVideo=(data,courseId)=>(dispatch)=>{
  ...
  fetch(`http://localhost:3005/videos/add/${courseId}`,{
    method:"POST",
    headers:{
      "Content-Type":"application/json",
      Authorization:`Bearer ${token}`
...
export const getProduct=(page,limit,search,order)=>(dispatch)=>{
    dispatch({type:PRODUCT_REQUEST})
    axios.get(`http://localhost:3005/courses?page=${page}&limit=${limit}&q=${search}&sortBy=price&sortOrder=${order}`,{
      headers:{
        Authorization:`Bearer ${token}`
      }
...
export const getUser=(page,limit,search,order)=>(dispatch)=>{
    dispatch({type:PRODUCT_REQUEST})
    axios.get(`http://localhost:3005/users?page=${page}&limit=${limit}`,{
      headers:{
        Authorization:`Bearer ${token}`
      }
...
export const getvideo=(page,limit,user)=>(dispatch)=>{
    dispatch({type:PRODUCT_REQUEST})
    axios.get(`http://localhost:3005/videos?page=${page}&limit=${limit}&user=${user}`,{
      headers:{
        Authorization:`Bearer ${token}`
      }
...
export const patchProduct=(id,data)=>(dispatch)=>{
  dispatch({type:PRODUCT_REQUEST})
  fetch(`http://localhost:3005/courses/update/${id}`,{
    method:"PATCH",
    headers:{
      "Content-Type":"application/json",
      Authorization:`Bearer ${token}`
...
export const patchUser=(id,data)=>(dispatch)=>{
  dispatch({type:PRODUCT_REQUEST})
  fetch(`http://localhost:3005/users/update/${id}`,{
    method:"PATCH",
    headers:{
      "Content-Type":"application/json",
      Authorization:`Bearer ${token}`
...
export const deleteProduct=(id)=>(dispatch)=>{
    dispatch({type:PRODUCT_REQUEST});
    axios.delete(`http://localhost:3005/courses/delete/${id}`,{
      headers:{
        Authorization:`Bearer ${token}`
      }
...
export const deleteUsers=(id)=>(dispatch)=>{
    dispatch({type:PRODUCT_REQUEST});
    axios.delete(`http://localhost:3005/users/delete/${id}`,{
      headers:{
        Authorization:`Bearer ${token}`
      }
    }).then((res)=>{console.log(res,"deleted");
